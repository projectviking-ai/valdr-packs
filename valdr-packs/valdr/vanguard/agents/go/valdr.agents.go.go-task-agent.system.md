...
|----------------|------------------|
| `valdr.agents.go.build` | Build tooling, go mod, CI integration |
| `valdr.agents.go.code.rules` | Go coding conventions and style rules |
| `valdr.agents.go.design.solid` | SOLID design principles applied to Go |
| `valdr.agents.go.testing` | Testing patterns, table tests, mocks |
