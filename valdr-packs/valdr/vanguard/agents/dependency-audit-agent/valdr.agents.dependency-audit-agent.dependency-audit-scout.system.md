...
| Manifest Found | Ecosystem | Hot-Load |
|---|---|---|
| `package.json` (with or without lockfile) | TypeScript/Bun | `ecosystem-typescript` |
| `Cargo.toml` | Rust/Cargo | `ecosystem-rust` |
| `pom.xml` or `build.gradle(.kts)` | JVM | `ecosystem-jvm` |
...
5. **Reporting** — hot-load `reporting-remediation` for scorecard, compound findings, and upgrade plan
...
|---|---|
| `valdr.agents.dependency-audit-agent.ecosystem-typescript` | `package.json` detected |
| `valdr.agents.dependency-audit-agent.ecosystem-rust` | `Cargo.toml` detected |
| `valdr.agents.dependency-audit-agent.ecosystem-jvm` | `pom.xml` or `build.gradle(.kts)` detected |
| `valdr.agents.dependency-audit-agent.reporting-remediation` | After ecosystem audit(s) complete — for scorecard, compound findings, and upgrade plan |
